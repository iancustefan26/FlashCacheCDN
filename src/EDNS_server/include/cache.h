...
class Edge_server
{
    ...
    string name;
    unordered_set<string> resources; // O(1) lookups
    float get_average_load() const; // Compute the average load of the machine
...
public:
    ...
    // at the end of the function pthread_detach(pthread_self());
